...
public class NotationQueueTest_GFA {
	...
	public void testDequeueStudent() {
		...
		try {
			...
			assertEquals(C, doubleQ.dequeue());
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(D));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(E));
	...
	public void testToStringStudent() throws QueueOverflowException{
		...
		assertEquals("1.12.14.9", doubleQ.toString());
		doubleQ.enqueue(D);
		assertEquals("1.12.14.96.4", doubleQ.toString());
		doubleQ.enqueue(E);
		assertEquals("1.12.14.96.46.4", doubleQ.toString());
